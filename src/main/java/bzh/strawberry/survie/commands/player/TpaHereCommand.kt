...
/*
 * This file (TpaHereCommand.kt) is part of a project Survie.
 * It was created on 17/07/2020 20:05 by Eclixal.
 * This file as the whole project shouldn't be modify by others without the express permission from Survie author(s).
 * Also this comment shouldn't get remove from the file. (see Licence.md)
 */
class TpaHereCommand(plugin: Plugin) : AbstractCommand(plugin, "survie.joueur") {
    ...
    override fun onCommand(commandSender: CommandSender, s: String, strings: Array<String>): Boolean {
        ...
        Survie.SURVIE.getSurviePlayer(requestPlayer.uniqueId).teleportRequest = TeleportRequest(player.uniqueId, requestPlayer.uniqueId, true)
        ...
        requestPlayer.sendMessage(Survie.SURVIE.prefix + "§e" + player.name + " §7veut vous téléporter")
