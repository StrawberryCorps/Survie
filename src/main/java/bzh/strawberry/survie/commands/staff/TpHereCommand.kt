...
/*
 * This file (TpHereCommand.kt) is part of a project Survie.
 * It was created on 17/07/2020 20:05 by Eclixal.
 * This file as the whole project shouldn't be modify by others without the express permission from Survie author(s).
 * Also this comment shouldn't get remove from the file. (see Licence.md)
 */
class TpHereCommand(plugin: Plugin) : AbstractCommand(plugin, "survie.moderation") {
    ...
    override fun onCommand(commandSender: CommandSender, s: String, strings: Array<String>): Boolean {
        ...
        if (strings.isNotEmpty()) {
            ...
            if (!Survie.SURVIE.getSurviePlayer(target.uniqueId).isTpToggle) {
