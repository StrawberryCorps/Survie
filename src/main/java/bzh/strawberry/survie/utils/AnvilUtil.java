...
/*
 * This file (AnvilUtil) is part of a project Survie.
...
public class AnvilUtil {
    ...
    private final Plugin plugin = Survie.SURVIE;
    ...
    public AnvilUtil(Player Player, final AnvilClickEventHandler Handler) {
        loadClasses();
        player = Player;
        handler = Handler;
